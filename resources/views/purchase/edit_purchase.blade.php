...
@section('content')
    <div class="row">
        {!! Form::model($purchase, ['route' => ['purchase.update', $purchase->id], 'method' => 'PUT', 'class' => 'form-horizontal row-border', 'id' => 'main-form', 'files' => true]) !!}
        <!--=== Vertical Forms ===-->
        <div class="col-md-12">
            <div class="widget box">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('promotion_id', $promotions, null, ['class' => 'select2 full-width-fix required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('date_booked', null, ['class' => 'form-control required makepickadate']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Approved</label>
                        <div class="col-md-9">
                            {!! Form::select('approved', ['YES' => 'YES', 'NO' => 'NO'], null, ['class' => 'select2 full-width-fix required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Scheduled</label>
                        <div class="col-md-9">
                            {!! Form::select('scheduled', ['YES' => 'YES', 'NO' => 'NO'], null, ['class' => 'select2 full-width-fix required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Paid</label>
                        <div class="col-md-1">
                            {!! Form::checkbox('paid', 1, (int) $purchase->paid === 1 ? true : false, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Spend Cost</label>
                        <div class="col-md-9">
                            {!! Form::text('spend_cost', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Number Sold</label>
                        <div class="col-md-9">
                            {!! Form::number('number_sold', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">KENP reads</label>
                        <div class="col-md-9">
                            {!! Form::number('kenp_reads', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">KENP rate</label>
                        <div class="col-md-9">
                            {!! Form::text('kenp_rate', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">KENP Tracking Start</label>
                        <div class="col-md-9">
                            {!! Form::text('start_date', null, ['class' => 'form-control makepickadate']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">KENP Tracking End</label>
                        <div class="col-md-9">
                            {!! Form::text('end_date', null, ['class' => 'form-control makepickadate']) !!}
                        </div>
                    </div>
