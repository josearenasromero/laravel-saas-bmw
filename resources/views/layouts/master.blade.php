...
<head>
    ...
    <title>Book Marketing Wizard (BMW) - @yield('title')</title>
    ...
    <script type="text/javascript" src="{{ URL::asset('plugins/slimscroll/jquery.slimscroll.horizontal.min.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ URL::asset('plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ URL::asset('plugins/bootstrap-inputmask/jquery.inputmask.min.js') }}">
    </script>

    <!-- Form Validation -->
    <script type="text/javascript" src="{{ URL::asset('plugins/validation/jquery.validate.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('plugins/datatables/responsive/datatables.responsive.js') }}">
    </script> <!-- optional -->
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="user" style="padding-top: 8px">
                    {!! Form::open(['route' => ['user.quit_view'], 'method' => 'POST', 'class' => 'form-action-buttons']) !!}
                ...
                <ul id="nav">
                    ...
                    <li class="<?php echo Request::is('promotionsite*') ? 'current open' : ''; ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            ?>
                            <li class="<?php echo Request::is('promotion/create') ? 'current open' : ''; ?>">
                                <a href="{{ url('/promotionsite/create') }}">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                    New Promotion Site
                                </a>
                            </li>
                    ...
                    <li class="<?php echo Request::is('report*') ? 'current open' : ''; ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="<?php echo Request::is('report/create') ? 'current open' : ''; ?>">
                                <a href="{{ url('/report/bookhistory') }}">
                                    <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                    Book History
                                </a>
                            </li>
                            <li class="<?php echo Request::is('report/create') ? 'current open' : ''; ?>">
                                <a href="{{ url('/report/promotionhistory') }}">
                                    <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                    Promotion History
                                </a>
                            </li>
...
<script type="text/javascript" src="{{ URL::asset('assets/js/dropzone-config.js') }}"></script>
<script>
    //JS utils
