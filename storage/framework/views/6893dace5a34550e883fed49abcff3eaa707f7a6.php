...
<?php $__env->startSection('title', 'Promotion Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo Form::model($promotion, ['route' => ['promotion.update', $promotion->id], 'method' => 'PUT', 'class' => 'form-horizontal row-border', 'id' => 'main-form', 'files' => true]); ?>
            ...
            <div class="widget box">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('title', null, ['class' => 'form-control', 'readonly' => 'readonly']); ?>

                            <?php echo Form::hidden('title_hidden', null, ['class' => 'form-control']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('color', null, ['class' => 'form-control required bs-colorpicker', 'data-colorpicker-guid' => '1', 'style' => 'background-color:' . $promotion->color]); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('start_date', null, ['class' => 'form-control required makepickadate']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('end_date', null, ['class' => 'form-control required makepickadate']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('price_during_sale', null, ['class' => 'form-control required']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('usual_price', null, ['class' => 'form-control required']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo Form::text('profit_rate', null, ['class' => 'form-control required']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/authorsxp/bmw/resources/views/promotion/edit_promotion.blade.php ENDPATH**/ ?>